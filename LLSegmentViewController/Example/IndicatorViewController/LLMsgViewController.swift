...
extension LLMsgViewController:LLSegmentCtlViewDelegate{    
    func segMegmentCtlView(segMegmentCtlView: LLSegmentCtlView, leftItemView: LLSegmentCtlItemView, rightItemView: LLSegmentCtlItemView, percent: CGFloat) {
